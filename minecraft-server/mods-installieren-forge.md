...
# 1. Anforderungen
Zuerst wird ein Forge-Server, ein [Fabric-Server](mods-installieren-fabric.md) oder ein [Mohist-Server](mods-und-plugins.md) für die <b>Java Edition von Minecraft</b> benötigt. Diese Server sind speziell für Mods gedacht.

# 2. Forge installieren
Falls du aktuell noch kein Forge installiert hast, kannst du dies noch nachträglich dazu installieren. Wie das geht, steht [hier](version-wechseln.md). Verwende dabei am besten die jeweils aktuelle, empfohlene Forge-Version zu deiner Minecraft-Version.
