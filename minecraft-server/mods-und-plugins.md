...
Falls du aktuell noch kein Mohist installiert hast, kannst du dies noch nachträglich dazu installieren. Wie das geht, steht [hier](version-wechseln.md). Verwende dabei am besten eine aktuelle, von Mohist unterstützte Minecraft-Version.
...
Einige Mods, die es auch als Plugins gibt (z.B. DynMap und Simple Voice Chat) erfordern, dass zusätzliche Ports freigegeben werden. Dies ist ebenfalls im Webinterface möglich. Für nähere Infos zur DynMap siehe bitte [hier](weltkarte.md), zur Bluemap siehe bitte [hier](3d-weltkarte.md) und für den Sprachchat siehe [hier](sprachchat.md).
