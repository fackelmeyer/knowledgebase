...
### 4. Konfiguration
Nach der Installation – das Standardverzeichnis lautet **C:\Program Files (x86)\Steam\steamapps\common\Terraria** – sind die folgenden vier Dateien für das Management und den späteren Start des Terraria-Servers sehr wichtig:
...
1. Terraria in gewohnter Manier starten.
